package com.example.madridtripplanner.application.data.local

import android.content.Context
import androidx.room.Database
import androidx.room.Room
import androidx.room.RoomDatabase
import com.example.madridtripplanner.application.data.local.dao.AppDataDao
import com.example.madridtripplanner.application.data.local.dao.BusLineDao
