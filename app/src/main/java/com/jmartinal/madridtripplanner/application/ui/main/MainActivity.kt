...
import com.jmartinal.madridtripplanner.application.ui.main.MainUiModel.*
import com.jmartinal.madridtripplanner.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showError(messageResID: Int) {
        MaterialAlertDialogBuilder(this)
            ...
            .setPositiveButton(getString(R.string.common_accept)) { _, _ -> finish() }
            .show()
    }
}